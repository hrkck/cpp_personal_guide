...
void sumMultiArray(int* theMatrix, int rowLenght, int columnLenght){
        ...
        for (int row = 0; row < rowLenght; row++) {
                for (int column = 0; column < columnLenght; column++) {
                        sum += *((theMatrix + row * columnLenght) + column); // theMatrix[row][column]; // <--TRY to understand this expression
                }
        }
        ...
        for (int row = 0; row < rowLenght; row++) {
                ...
                for (int column = 0; column < columnLenght; column++) {
                        cout << *((theMatrix + row * columnLenght) + column) << "\t"; // <--TRY to understand this expression
                }
                cout << endl;
        }
